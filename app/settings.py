...
SECRET_KEY = 'django-insecure-#dr59^cemaqqeksxqp&7rrsbi()woe!x_$1c6yb9^)64p$$h0_'
...
TEMPLATES = [
    {
        ...
        # 👇 point Django to your app/templates folder
...
# 👇 tell Django where your app/static folder is
STATICFILES_DIRS = [
    BASE_DIR / "app" / "static",
]
